...
2、使用环境
	...
	软件开发环境：KEIL MDK-ARM Professional Version 5.26.2.0
        ...
        硬件环境：最小系统板N32L43XML-STB_V1.0、IrDA发送器及接收器
...
2. Use environment
        ...
        Hardware environment: minimum system board N32L43XML-STB_V1.0, IrDA transmitter and receiver
