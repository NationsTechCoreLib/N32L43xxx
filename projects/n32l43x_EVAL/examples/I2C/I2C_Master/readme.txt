...
3、使用说明
    ...
    5、测试步骤与现象
        a，用两块N32L43XML-STB开发板，一块做主设备，另一块做从设备
...
Software development environment:
    ...
    Hardware environment:
        Development board N32L43XML-STB V1.0
...
3. Instructions for use
    ...
    5. Test steps and phenomena
        a. Use two N32L43XML-STB development boards, one as the master device and the other as the slave device
