...
3、使用说明
    ...
    系统配置:
        ...
        3、串口配置：
                            ...
                            - 波特率： 115200 
    使用方法：
        1、编译后烧录到评估板，上电后，人为给PC13灌入高电平，串口输出RTC Tamper Interrupt。说明
           入侵检测发生了入侵中断
                
4、注意事项
    PC13配置为入侵检测浮空输入，N32L43XM-STB V1.0 PC13 引脚输入电平不确定容易导致误触发RTC 入侵检测，
...
4. Matters needing attention
	PC13 is configured as an intrusion detection floating input, n32L43XML-STB V1.0 PC13 pin input level is uncertain, which can easily trigger RTC tamper detection by mistake.
